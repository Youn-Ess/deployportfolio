...
export const Logo = () => {
    ...
    return (
        <>
            <motion.svg onClick={handleRefresh} version="1.1" width="110" height="90" className="z-50" viewBox="0 0 3187.5 2243.8939355696903"
                    ...
                    <g id="SvgjsG1190" featureKey="odWo6G-0" transform="matrix(2,0,0,2,0,60)" fill="#000">
                        ...
                        <g xmlns="http://www.w3.org/2000/svg">
                            <motion.path
                                ...
                                {...combinedVariant2}
                                fill={lightBalckColor}
                                animate="visible"
                                initial="hidden"
                                stroke={lightBalckColor}
